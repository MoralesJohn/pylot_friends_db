...
routes["POST"]["/add_submit"] = "Friends#add_submit"
routes['GET']['/show/<id>'] = 'Friends#show'
routes['GET']['/edit/<id>'] = 'Friends#edit'
routes['POST']['/edit_submit/<id>'] = "Friends#edit_submit"
routes['GET']['/delete/<id>'] = "Friends#delete"
routes['GET']['/delete_submit/<id>'] = "Friends#delete_submit"
"""
